...
execute if data storage lsystem active.id.bin_tree run say Processed next iteration of Hilbert Curve
...
execute if data storage lsystem active.id.dragon run say Processed next iteration of Binary Tree
