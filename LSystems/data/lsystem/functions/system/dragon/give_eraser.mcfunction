...
scoreboard players add @s give_dragon 1
scoreboard players operation @s give_dragon *= IterMultiplier lsystem_itr

function lsystem:system/dragon/give_set_data
