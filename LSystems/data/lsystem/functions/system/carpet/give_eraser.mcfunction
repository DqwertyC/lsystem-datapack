...
scoreboard players add @s give_carpet 1
scoreboard players operation @s give_carpet *= IterMultiplier lsystem_itr

function lsystem:system/carpet/give_set_data
