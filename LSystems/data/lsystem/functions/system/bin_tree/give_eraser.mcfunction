...
scoreboard players add @s give_bin_tree 1
scoreboard players operation @s give_bin_tree *= IterMultiplier lsystem_itr

function lsystem:system/bin_tree/give_set_data
